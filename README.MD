...
- [ ] `AbstractRepositoryController`: it's not good the ID is in the URL and the TValue
- [ ] tests for endpoint and controller test for create and update are missing
